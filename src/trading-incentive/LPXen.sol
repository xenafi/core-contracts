...
contract LPXen is Initializable, OwnableUpgradeable, IERC20 {
    ...
    string public constant name = "Xena Loyalty Program";
    string public constant symbol = "lpXEN";
    uint8 public constant decimals = 18;
    uint256 public constant PRECISION = 1e6;
    uint256 public constant MIN_EPOCH_DURATION = 1 days;
    uint256 public constant MAX_BATCH_VESTING_DURATION = 7 days;
    IERC20 public constant rewardToken = IERC20(0x0000000000000000000000000000000000000000);
    ...
    function mint(address _to, uint256 _amount) external {
        require(_msgSender() == minter, "LPXen: !minter");
        _mint(_to, _amount);
    }
    ...
    function claimRewards(uint256 _batchId, address _receiver) public {
        ...
        require(amount > 0, "LPXen: nothing to claim");
    ...
    function setMinter(address _minter) external onlyOwner {
        require(_minter != address(0), "LPXen: zero address");
        minter = _minter;
