...
contract ReferralRewarder is Initializable, OwnableUpgradeable {
    ...
    address public constant XEN = 0x0000000000000000000000000000000000000000;
        ...
        external
    {
        ...
        IERC20(XEN).safeTransfer(_to, _claimableRewards);
    ...
    function recoverFund(address _receiver, uint256 _amount) external onlyOwner {
        ...
        IERC20(XEN).safeTransfer(_receiver, _amount);
