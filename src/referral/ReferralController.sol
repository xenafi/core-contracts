...
contract ReferralController is Initializable, OwnableUpgradeable {
    ...
    function initialize(address _oracle, address _registry, uint256 _epochDuration) external initializer {
    ...
    function nextEpoch() external {
        ...
        epochs[currentEpoch].xenTWAP = uint128(oracle.lastTWAP());
    ...
    function start(uint256 _startTime) external onlyOwner {
        ...
        currentEpoch = 0; // start where controller v2 stop
