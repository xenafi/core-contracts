...
import "../src/staking/OmniStaking.sol";
...
contract OmniStakingTest is Test {
    ...
    function setUp() external {
        ...
        Proxy omniStakingProxy = new Proxy(
            address(new OmniStaking()),
            address(proxyAdmin),
            new bytes(0)
        );
        lvlStaking = OmniStaking(address(omniStakingProxy));
